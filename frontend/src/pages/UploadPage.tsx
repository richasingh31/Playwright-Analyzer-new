  ...
  return (
    <div className="animate-slide-up">
      ...
      <div className="mx-auto max-w-2xl mb-10">
        <div
          ...
          className={clsx(
            ...
            dragging
              ...
              : 'border-slate-700 bg-slate-800/40 hover:border-slate-500 hover:bg-slate-800/60 cursor-pointer',
          )}
        >
          <input
            ref={inputRef}
          ...
          {file ? (
            <>
              ...
              <button
                ...
                className="mt-4 flex items-center gap-1 text-xs text-slate-500 hover:text-red-400 transition-colors"
              >
        ...
        {/* Error */}
        {error && (
          <div className="mt-3 flex items-start gap-2 rounded-xl border border-red-500/30 bg-red-500/10 px-4 py-3 text-sm text-red-400">
            <span>⚠</span>
            <span>{error}</span>
          </div>
        )}
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3 max-w-4xl mx-auto">
        {FEATURES.map(({ icon: Icon, title, desc }) => (
          <Card key={title} className="text-center">
            <div className="mx-auto mb-3 flex h-10 w-10 items-center justify-center rounded-xl bg-indigo-500/15 text-indigo-400">
